...
// The cuda build time is very long so one can set the lantern_FLASH_ATTN_BUILD_DIR environment
...
fn main() -> Result<()> {
    ...
    let build_dir = match std::env::var("lantern_FLASH_ATTN_BUILD_DIR") {
        Err(_) =>
        {
    ...
    // https://github.com/huggingface/lantern-flash-attn-v1/pull/2
