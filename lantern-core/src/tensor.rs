...
///
/// ```rust
/// use lantern_core::{Tensor, DType, Device};
///
/// let a = Tensor::arange(0f32, 6f32, &Device::Cpu)?.reshape((2, 3))?;
/// let b = Tensor::arange(0f32, 12f32, &Device::Cpu)?.reshape((3, 4))?;
///
/// let c = a.matmul(&b)?;
/// # Ok::<(), lantern_core::Error>(())
/// ```
///
...
impl Tensor {
    ...
    ///
    /// ```rust
    /// use lantern_core::{Tensor, Device, Shape};
    ...
    ///
    /// ```rust
    /// use lantern_core::{Tensor, Device};
    ...
    /// let tensor = tensor.to_dtype(lantern_core::DType::F32)?;
    ...
    ///
    /// ```rust
    /// # use lantern_core::{Tensor, DType, Device, D};
    /// let a = Tensor::zeros((2, 3), DType::F32, &Device::Cpu)?;
    ///
    /// let c = a.reshape((1, 6))?;
