...
use lantern_metal_kernels::{BufferOffset, CallConvTranspose2dCfg, Kernels};
...
pub enum MetalError {
    ...
    Message(String),
    #[error(transparent)]
    KernelError(#[from] lantern_metal_kernels::MetalKernelError),
    #[error("{0:?}")]
    LockError(LockError),
...
impl BackendStorage for MetalStorage {
    ...
    fn affine(&self, layout: &Layout, mul: f64, add: f64) -> Result<Self> {
        ...
        if layout.is_contiguous() {
            ...
            lantern_metal_kernels::call_affine(
                &device.device,
                &command_buffer,
                &device.kernels,
                name,
            ...
            lantern_metal_kernels::call_affine_strided(
                &device.device,
                &command_buffer,
                &device.kernels,
                name,
    ...
    fn powf(&self, layout: &Layout, pow: f64) -> Result<Self> {
        ...
        if layout.is_contiguous() {
            ...
            lantern_metal_kernels::call_powf(
                &device.device,
                &command_buffer,
                &device.kernels,
                name,
            ...
            lantern_metal_kernels::call_powf_strided(
                &device.device,
                &command_buffer,
                &device.kernels,
                name,
    ...
    fn elu(&self, layout: &Layout, alpha: f64) -> Result<Self> {
        ...
        if layout.is_contiguous() {
            ...
            lantern_metal_kernels::call_elu(
                &device.device,
                &command_buffer,
                &device.kernels,
                name,
            ...
            lantern_metal_kernels::call_elu_strided(
                &device.device,
                &command_buffer,
                &device.kernels,
                name,
    ...
    fn reduce_op(&self, op: ReduceOp, layout: &Layout, sum_dims: &[usize]) -> Result<Self> {
        ...
        let command_buffer = self.device.command_buffer()?;
        let src = buffer_o(&self.buffer, layout, self.dtype);
        lantern_metal_kernels::call_reduce_strided(
            &device.device,
            &command_buffer,
            &device.kernels,
            name,
    ...
    fn to_dtype(&self, layout: &Layout, dtype: DType) -> Result<Self> {
        ...
        if layout.is_contiguous() {
            ...
            lantern_metal_kernels::call_cast_contiguous(
                &device.device,
                &command_buffer,
                &device.kernels,
                kernel_name,
            ...
            lantern_metal_kernels::call_cast_strided(
                &device.device,
                &command_buffer,
                &device.kernels,
                kernel_name,
    ...
    fn where_cond(
        ...
        lantern_metal_kernels::call_where_cond_strided(
            &device.device,
            &command_buffer,
            &device.kernels,
            name,
    ...
    fn conv1d(
        ...
        let src = buffer_o(&self.buffer, layout, self.dtype);
        lantern_metal_kernels::call_im2col1d_strided(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn conv_transpose1d(
        ...
        let buffer = if USE_COL2IM_CONV1D_TR && can_use_col2im {
            ...
            let command_buffer = self.device.command_buffer()?;
            lantern_metal_kernels::call_col2im1d(
                &self.device.device,
                &command_buffer,
                &self.device.kernels,
                name,
            ...
            lantern_metal_kernels::call_conv_transpose1d(
                &self.device.device,
                &command_buffer,
                &self.device.kernels,
                name,
    ...
    fn conv2d(
        ...
        let src = buffer_o(&self.buffer, layout, self.dtype);
        lantern_metal_kernels::call_im2col_strided(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn conv_transpose2d(
        ...
        lantern_metal_kernels::call_conv_transpose2d(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn avg_pool2d(
        ...
        lantern_metal_kernels::call_pool2d(
            &self.device.device,
            &command_buffers,
            &self.device.kernels,
            name,
    ...
    fn upsample_nearest2d(&self, inp_l: &Layout, out_w: usize, out_h: usize) -> Result<Self> {
        ...
        lantern_metal_kernels::call_upsample_nearest_2d(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn gather(&self, src_l: &Layout, ids: &Self, ids_l: &Layout, dim: usize) -> Result<Self> {
        ...
        lantern_metal_kernels::call_gather(
            &device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn scatter_add(
        ...
        let ids = buffer_o(&ids.buffer, ids_l, ids.dtype);
        lantern_metal_kernels::call_scatter_add(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn index_select(&self, ids: &Self, src_l: &Layout, ids_l: &Layout, dim: usize) -> Result<Self> {
        ...
        let src = buffer_o(&self.buffer, src_l, dtype);
        let ids = buffer_o(&ids.buffer, ids_l, ids.dtype);
        lantern_metal_kernels::call_index_select(
            &device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn index_add(
        ...
        let src = buffer_o(&src.buffer, src_l, src.dtype);
        let ids = buffer_o(&ids.buffer, ids_l, ids.dtype);
        lantern_metal_kernels::call_index_add(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn matmul(
        ...
        lantern_metal_kernels::call_gemm(
            &self.device.device,
            &command_buffer,
            &self.device.kernels,
            name,
    ...
    fn copy2d(
        ...
        if src_s == d2 && dst_s == d2 {
            ...
            let kernel_name = match self.dtype {
                DType::F32 => lantern_metal_kernels::copy2d::FLOAT,
                DType::F16 => lantern_metal_kernels::copy2d::HALF,
                DType::BF16 => lantern_metal_kernels::copy2d::BFLOAT,
                DType::I64 => lantern_metal_kernels::copy2d::I64,
                DType::U32 => lantern_metal_kernels::copy2d::U32,
                DType::U8 => lantern_metal_kernels::copy2d::U8,
                dtype => crate::bail!("Metal copy2d {dtype:?} not implemented"),
            };
            lantern_metal_kernels::call_copy2d(
                &self.device.device,
                &command_buffer,
                &self.device.kernels,
                kernel_name,
    ...
    fn copy_strided_src(&self, dst: &mut Self, dst_offset: usize, src_l: &Layout) -> Result<()> {
        ...
        if src_l.is_contiguous() && self.dtype == dst.dtype() {
            ...
            let kernel_name = match self.dtype {
                DType::F32 => lantern_metal_kernels::unary::strided::copy::FLOAT,
                DType::F16 => lantern_metal_kernels::unary::strided::copy::HALF,
                DType::BF16 => lantern_metal_kernels::unary::strided::copy::BFLOAT,
                DType::I64 => lantern_metal_kernels::unary::strided::copy::I64,
                DType::U32 => lantern_metal_kernels::unary::strided::copy::U32,
                DType::U8 => lantern_metal_kernels::unary::strided::copy::U8,
...
impl MetalStorage {
    ...
    pub fn binary(
        ...
        let (buffer, dtype) = if lhs_l.is_contiguous() && rhs_l.is_contiguous() && &op[..1] != "b" {
            use lantern_metal_kernels::binary::contiguous;
            ...
            lantern_metal_kernels::call_binary_contiguous(
                &device.device,
                &command_buffer,
                &device.kernels,
                kernel_name,
            ...
            use lantern_metal_kernels::binary::strided;
            ...
            let buffer = device.new_buffer(el_count, dtype, op)?;
            lantern_metal_kernels::call_binary_strided(
                &device.device,
                &command_buffer,
                &device.kernels,
                kernel_name,
...
impl BackendDevice for MetalDevice {
    ...
    fn new(ordinal: usize) -> Result<Self> {
        ...
        let compute_per_buffer = match std::env::var("lantern_METAL_COMPUTE_PER_BUFFER") {
            Ok(val) => val.parse()?,
            _ => 50,
        };
    ...
    fn rand_uniform(
        ...
        lantern_metal_kernels::call_random_uniform(
            &self.device,
            &command_buffer,
            &self.kernels,
            name,
    ...
    fn rand_normal(
        ...
        let command_buffer = self.command_buffer()?;
        lantern_metal_kernels::call_random_normal(
            &self.device,
            &command_buffer,
            &self.kernels,
            name,
