# This example shows how the lantern Python api can be used to replicate llama.cpp.
import sys
from typing import Dict, Tuple, Any
import lantern
from lantern.models.llama import QuantizedLlama
from lantern import utils
...
def main():
    ...
    for token_idx in range(500):
        last_token = tokens[-1]
        lt = lantern.tensor([last_token]).unsqueeze(0)
        logits = model.forward(lt, len(tokens))
        # Greedy sampling for now
        # pr = lantern.nn.softmax(logits, -1)
