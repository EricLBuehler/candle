...
"""
lantern_SPECIFIC_TYPING = "from lantern.typing import _ArrayLike, Device, Scalar, Index, Shape\n"
lantern_TENSOR_IMPORTS = "from lantern import Tensor,DType,QTensor\n"
...
def pyi_file(obj, indent=""):
    ...
    if inspect.ismodule(obj):
        ...
        string += TYPING
        string += lantern_SPECIFIC_TYPING
        if obj.__name__ != "lantern.lantern":
            string += lantern_TENSOR_IMPORTS
...
if __name__ == "__main__":
    ...
    # Enable execution from the lantern and lantern-pyo3 directories
    cwd = Path.cwd()
    directory = "py_src/lantern/"
    if cwd.name != "lantern-pyo3":
        directory = f"lantern-pyo3/{directory}"
    ...
    write(lantern.lantern, directory, "lantern", check=args.check)
