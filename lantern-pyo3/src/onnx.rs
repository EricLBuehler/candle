...
use lantern_onnx::eval::{dtype, get_tensor, simple_eval};
use lantern_onnx::onnx::tensor_proto::DataType;
use lantern_onnx::onnx::tensor_shape_proto::dimension::Value;
use lantern_onnx::onnx::type_proto::{Tensor as ONNXTensor, Value as ONNXValue};
use lantern_onnx::onnx::{ModelProto, ValueInfoProto};
...
impl PyONNXModel {
    ...
    fn new(path: String) -> PyResult<Self> {
        let model: ModelProto = lantern_onnx::read_file(path).map_err(wrap_err)?;
