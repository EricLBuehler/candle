...
//!
//! ```rust
//! use lantern::{Tensor, Device::Cpu, test_utils::to_vec3_round};
//! use lantern_nn::{LayerNorm, Module};
        ...
        match (
            ...
            (Storage::Cuda(x_storage), Storage::Cuda(weight_storage)) => {
                match (x_storage.dtype(), weight_storage.dtype()) {
                    ...
                    _ => lantern::bail!("DType mismatch in fused rmsnorm."),
                }
            }
            _ => unreachable!(),
        }
