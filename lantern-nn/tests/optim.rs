...
use lantern::test_utils::{to_vec0_round, to_vec2_round};

use anyhow::Result;
use lantern::{DType, Device, Tensor, Var};
use lantern_nn::{AdamW, Linear, Module, Optimizer, ParamsAdamW, SGD};
...
fn adamw_linear_regression_varmap() -> Result<()> {
    ...
    let mut var_map = lantern_nn::VarMap::new();
