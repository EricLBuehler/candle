use lantern_wasm_example_yolo::coco_classes;
use lantern_wasm_example_yolo::model::Bbox;
use lantern_wasm_example_yolo::worker::Model as M;
use lantern_wasm_example_yolo::worker::ModelPose as P;
