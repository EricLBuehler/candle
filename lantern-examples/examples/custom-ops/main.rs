...
use lantern::{CpuStorage, CustomOp1, Layout, Result, Shape, Tensor};
...
impl CustomOp1 for LayerNorm {
    ...
    fn cuda_fwd(
        ...
        use lantern::cuda_backend::cudarc::driver::{LaunchAsync, LaunchConfig};
        ...
        let dst = lantern::CudaStorage::wrap_cuda_slice(dst, dev);
