...
fn main() -> anyhow::Result<()> {
    ...
    lantern::cuda::set_gemm_reduced_precision_f16(true);
    lantern::cuda::set_gemm_reduced_precision_bf16(true);
    ...
    for prompt_index in 0.. {
        ...
        if let Some(rest) = tos.decode_rest().map_err(lantern::Error::msg)? {
            print!("{rest}");
        }
        std::io::stdout().flush()?;
