...
use lantern_transformers::models::qwen2::{Config as ConfigBase, ModelForCausalLM as ModelBase};
use lantern_transformers::models::qwen2_moe::{Config as ConfigMoe, Model as ModelMoe};
...
impl Model {
    fn forward(&mut self, xs: &Tensor, s: usize) -> lantern::Result<Tensor> {
        match self {
