...
use lantern_transformers::models::stable_diffusion;
use lantern_transformers::models::wuerstchen;
...
fn run(args: Args) -> Result<()> {
    ...
    let device = lantern_examples::device(cpu)?;
    ...
    let image_embeddings = {
        ...
        let prior = {
            ...
            let vb = unsafe {
                lantern_nn::VarBuilder::from_mmaped_safetensors(&[file], DType::F32, &device)?
            };
    ...
    for idx in 0..num_samples {
        ...
        lantern_examples::save_image(&image, image_filename)?
    }
    Ok(())
}
