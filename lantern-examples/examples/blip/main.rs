...
use lantern::{DType, Device, Result, Tensor};
use lantern_examples::token_output_stream::TokenOutputStream;
use lantern_nn::VarBuilder;
use lantern_transformers::models::blip;
use lantern_transformers::models::quantized_blip;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let model_file = match args.model {
        None => {
            ...
            if args.quantized {
                let api = api.model("lmz/lantern-blip".to_string());
    ...
    let mut logits_processor =
        lantern_transformers::generation::LogitsProcessor::new(1337, None, None);
