# lantern-yolo-v8: Object Detection and Pose Estimation
...
You can try this model online on the [lantern YOLOv8
Space](https://huggingface.co/spaces/lmz/lantern-yolo). The model then fully runs
...
### Object Detection
```bash
cargo run --example yolo-v8 --release -- lantern-examples/examples/yolo-v8/assets/bike.jpg
```
...
cargo run --example yolo-v8 --release -- \
  lantern-examples/examples/yolo-v8/assets/bike.jpg --task pose
```
