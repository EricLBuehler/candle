...
use lantern::DType::{F32, U8};
use lantern::{DType, Device, Module, Result, Tensor};
use lantern_examples::{load_image, load_image_and_resize, save_image};
use lantern_nn::VarBuilder;
use lantern_transformers::models::depth_anything_v2::{DepthAnythingV2, DepthAnythingV2Config};
use lantern_transformers::models::dinov2;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let dinov2_model_file = match args.dinov2_model {
        None => {
            ...
            let api = api.model("lmz/lantern-dino-v2".into());
