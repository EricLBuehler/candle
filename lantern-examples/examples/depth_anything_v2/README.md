...
```bash
cargo run --features cuda,depth_anything_v2 --package lantern-examples --example depth_anything_v2 -- --color-map --image lantern-examples/examples/yolo-v8/assets/bike.jpg 
```
