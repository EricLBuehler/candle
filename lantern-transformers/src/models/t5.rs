...
pub struct ActivationWithOptionalGating {
    pub gated: bool,
    pub activation: lantern_nn::Activation,
}
    ...
    D: serde::de::Deserializer<'de>,
{
    match String::deserialize(deserializer)?.as_str() {
        "gated-gelu" => Ok(ActivationWithOptionalGating {
            gated: true,
            activation: lantern_nn::Activation::NewGelu,
        }),
        "gated-silu" => Ok(ActivationWithOptionalGating {
            gated: true,
            activation: lantern_nn::Activation::Silu,
        }),
        buf => {
...
impl T5Attention {
    ...
    fn forward(
        ...
        let attn_weights = {
            ...
            lantern_nn::ops::softmax_last_dim(&scores)?
        };
