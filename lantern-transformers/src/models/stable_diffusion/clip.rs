...
use lantern::{DType, Device, Result, Tensor, D};
...
impl ClipTextEmbeddings {
    fn new(vs: lantern_nn::VarBuilder, c: &Config) -> Result<Self> {
        let token_embedding =
            lantern_nn::embedding(c.vocab_size, c.embed_dim, vs.pp("token_embedding"))?;
        let position_embedding = lantern_nn::embedding(
...
impl ClipTextTransformer {
    pub fn new(vs: lantern_nn::VarBuilder, c: &Config) -> Result<Self> {
