...
use lantern_nn::{layer_norm, LayerNorm, VarBuilder};
...
impl Config {
    ...
    pub fn vit_base_patch16_224() -> Self {
        Self {
            ...
            hidden_act: lantern_nn::Activation::Gelu,
...
impl Embeddings {
    ...
    pub fn forward(
        ...
        let embeddings = match (bool_masked_pos, &self.mask_token) {
            (None, _) => embeddings,
            (Some(_), None) => lantern::bail!("bool_masked_pos set without mask_token"),
...
struct Intermediate {
    dense: Linear,
    intermediate_act_fn: lantern_nn::Activation,
}
