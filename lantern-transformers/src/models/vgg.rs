...
use lantern::{ModuleT, Result, Tensor};
use lantern_nn::{FuncT, VarBuilder};
...
fn fully_connected(
    ...
    let dropout1 = lantern_nn::Dropout::new(0.5);
    let dropout2 = lantern_nn::Dropout::new(0.5);
    let dropout3 = lantern_nn::Dropout::new(0.5);
    Ok(FuncT::new(move |xs, train| {
        ...
        let lin3 = lantern_nn::linear(4096, num_classes, vb.pp("head.fc"))?;
